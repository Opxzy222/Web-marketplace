...
const ShopPage = () => {
  ...
  // Subscription & Data fetching (unchanged)
        ...
        <div className="content-wrapper">
          ...
          <div className="shop-hero-card">
            <div className="shop-image-section">
              ...
              {/* Rating Badge - top left - exact RN style */}
              ...
              {/* Verified Badge - top right - exact RN style with overlay check */}
                ...
                {shop.owner_is_verified && (
                  <div className="owner-verified-badge">
                    ...
                    <div className="verified-icon-overlay">
                      <CheckCircle2 size={10} color="#0FA958" fill="#0FA958" />
                    </div>
                  </div>
                )}
              </div>

              {/* Open/Closed Status - bottom right - pulsing animation */}
            ...
            <div className="shop-info-section">
              ...
              <div className="action-buttons-row">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(`/shop/StartConversation?shopId=${shopId}&name=${encodeURIComponent(shop.name)}`)
                  }
                >
            ...
            <div className="card categories-card">
              ...
              <AnimatePresence>
                {selectedCategory && (
                  ...
                  >
                    <p>
                      {selectedCategory.name} – Explore products and services in this category.
                    </p>
          ...
          <div className="tabs-container">
            {['products', 'posts', 'customers', 'reviews'].map((tab) => (
              <motion.button
                key={tab}
          ...
          <div className="tab-content-card">
            {activeTab === 'products' && <ShopProduct shopId={shopId} category={shop.category?.name} />}
            {activeTab === 'services' && <ShopProduct shopId={shopId} category={shop.category?.name} />}
            {activeTab === 'posts' && (
              isFreeUser ? (
                posts.length > 0 ? (
